...
interface Pubnub {
  CATEGORIES: Pubnub.Categories;

  OPERATIONS: Pubnub.Operations;

  generateUUID(): string;

  notificationPayload(title: string, body: string): Pubnub.NotificationsPayload;
  ...
  createUser(
    params: Pubnub.UserInputParameters,
  ): Promise<Pubnub.GetUserResponse>;
  ...
  getUsers(
    params: Pubnub.GetObjectsParameters,
  ): Promise<Pubnub.GetUsersResponse>;
  ...
  createSpace(
    params: Pubnub.SpaceInputParameters,
  ): Promise<Pubnub.GetSpaceResponse>;
  ...
  getSpaces(
    params: Pubnub.GetObjectsParameters,
  ): Promise<Pubnub.GetSpacesResponse>;
  ...
  getMemberships(
    params: Pubnub.GetMembershipsParameters,
  ): Promise<Pubnub.GetMembershipsResponse>;
  ...
  getMembers(
    params: Pubnub.GetMembersParameters,
  ): Promise<Pubnub.GetMembersResponse>;
